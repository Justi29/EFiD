...
W badaniu wykorzystano dane spółki BETACOM, która została wybrana samodzielnie z ostatnich 20 spółek znajdujących się w rankingu WIG, gdyż po zostosowaniu wzoru z polecenia, numer ten nie występował już w rankingu. 
...
```
Prognozy modelu logarytmicznych stóp zwrotu są bliskie zera, natomiast dla logarytmicznych cen oscylują wokół 1.48 dla każdej obserwacji. Rzeczywiste wartości w obu przypadkach cechują się większą zmiennością, lecz nadal mieszczą się w szerokich przedziałach ufności, co świadczy o niepewności przewidywań. Prognozy cen zamknięcia pozostają stabilne, zbliżone do 4.418, jednak szerokie przedziały ufności wskazują na trudności w precyzyjnym prognozowaniu tych wartości.
