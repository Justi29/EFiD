...
W tym celu obliczono logarytmy cen i logarytmicznych stóp zwrotu, zbadano stacjonarność, dopasowano model do stóp zwrotu a następnie wysznaczono prognozy, stosując symulacje Monte Carlo oraz bootstrap. Na końcu przeprowadzono badanie ponownie, uwzględniając występowanie efektu ARCH. 
